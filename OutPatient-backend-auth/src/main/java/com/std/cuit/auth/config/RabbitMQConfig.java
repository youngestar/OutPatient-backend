...
public class RabbitMQConfig {
    ...
    // 使用 auth 模块自己的常量或直接使用字符串
    public static final String FEEDBACK_MESSAGE_EXCHANGE = "feedback.message.exchange";
    ...
    public TopicExchange feedbackMessageExchange() {
        return new TopicExchange(FEEDBACK_MESSAGE_EXCHANGE);
    }
    ...
    public Queue feedbackMessageQueue() {
        return QueueBuilder.durable(FEEDBACK_QUEUE_NAME)
