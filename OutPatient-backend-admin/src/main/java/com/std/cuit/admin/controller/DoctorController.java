...
public class DoctorController {
    ...
    public BaseResponse<Long> addDoctor(
            @Parameter(description = "医生信息") @ModelAttribute AddDoctorRequest addDoctorRequest
    ) {
        log.info("接收到添加医生请求: {}", addDoctorRequest);
    ...
    public BaseResponse<Boolean> updateDoctor(
            @Parameter(description = "医生信息") @ModelAttribute UpdateDoctorRequest updateDoctorRequest
    ) {
        log.info("修改医生信息: {}", updateDoctorRequest);
